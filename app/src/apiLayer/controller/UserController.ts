...
import { authorSystem } from '../../businessLayer/systems/AuthorSystem';
...
class UserController {
    ...
    public async register(req: express.Request, res: express.Response) {
        try {
            ...
            const createdUser = await userService.createUser(email, hashedPass, first_name, last_name, roleType, status_type);
    ...
    public async deactivate(req: express.Request, res: express.Response) {
        try {
            ...
            await authorSystem.changeActiveStatus(userId, StatusType.Inactive);
