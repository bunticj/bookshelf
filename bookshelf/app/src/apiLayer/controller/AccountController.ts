...
class AccountController {
    ...
    public async deactivate(req: express.Request, res: express.Response) {
        try {
            ...
            if (isNaN(wantedPlayerId)) throw new CustomError(ErrorType.BadRequest, "Invalid user id");
    ...
    public async deleteUser(req: express.Request, res: express.Response) {
        try {
            ...
            if (isNaN(userId)) throw new CustomError(ErrorType.BadRequest, "Invalid user id");
    ...
    public async updateUser(req: express.Request, res: express.Response) {
        try {
            const userId = +req.params.userId;
            if (isNaN(userId)) throw new CustomError(ErrorType.BadRequest, "Invalid user id", { userId });
